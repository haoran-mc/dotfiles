...
sketchybar --add       item               discord right                                       \
           --set       discord            background.image=/Users/haoran/.config/sketchybar/assets/discord-logo.png \
...
#            --set       spotify            background.image=/Users/haoran/.config/sketchybar/assets/spotify-logo.png \
...
sketchybar --add       item               obs right                                       \
           --set       obs                background.image=/Users/haoran/.config/sketchybar/assets/obs-logo.png \
