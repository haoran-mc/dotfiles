...
_, _ = pcall(telescope.load_extension, 'fzf')
_, _ = pcall(telescope.load_extension, "ui-select")
_, _ = pcall(telescope.load_extension, 'dap')
_, _ = pcall(telescope.load_extension, 'vim_bookmarks')
_, _ = pcall(telescope.load_extension, 'projects')
