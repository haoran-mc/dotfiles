...
"General settins {{{
set title titlestring=NEXTLINE
...
" Vim Directories {{{
" ---------------
" exec 'cd ' . fnameescape('/home/haoran')
set autochdir
set nobackup
set nowritebackup
set undofile noswapfile   " Disallow temporary file generation
...
set list                " Displays invisible whitespace
