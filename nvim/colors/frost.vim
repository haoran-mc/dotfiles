...
:exe  'highlight  Normal          guifg=White      guibg=Black   guisp='.ui_11.'   gui=NONE       ctermfg=White   ctermbg=Black   cterm=NONE'
...
:exe  'highlight  Search          guifg='.ui_11.'    guibg=Orange  guisp='.yellow.'  gui=NONE       ctermfg=237   ctermbg=229   cterm=NONE'
...
:exe  'highlight  VertSplit       guifg='.ui_8.'     guibg=NONE   guisp='.ui_11.'   gui=bold       ctermfg=60    ctermbg=NONE   cterm=bold'
